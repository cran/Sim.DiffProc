...
Created using [ggplot2](https://cran.r-project.org/package=ggplot2) package plotted in (x, y)-space with `dim = 2`. A contour plot of density obtained from a realization of system $(X_{t},Y_{t})$ at time `t=10`.
...
A $3$D plot of the density obtained with [sm](https://cran.r-project.org/package=sm), from a realization of system $(X_{t},Y_{t})$ at time `t=10`. 
