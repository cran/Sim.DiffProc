...
.SMilstein1D <- function(N =100,M=1,x0=2,t0=0,T=1,Dt,drift,diffusion,
                          type=c("ito","str"),...)
                       {
    if (missing(Dt)) {
    ...
    X[1] <- x0 
    for (i in 2:(N+1)){
       X[i] = X[i-1] + A(t[i-1],X[i-1])*Dt + S(t[i-1],X[i-1])*dw[i-1] +0.5 *S(t[i-1],X[i-1]) *
              Sx(t[i-1],X[i-1])*(dw[i-1]^2-Dt)+ Dt^(3 /2)*(0.5 *A(t[i-1],X[i-1])*Sx(t[i-1],X[i-1]) + 
              0.5 * Ax(t[i-1],X[i-1])*S(t[i-1],X[i-1])+ 0.25 *(S(t[i -1] ,X[i -1])^2) *Sxx(t[i -1] ,X[i -1]))*
              dw[i -1]+ (Dt^2) * (0.5*A(t[i -1],X[i -1])*Ax(t[i-1],X[i-1])+ 0.25 *Axx(t[i-1],X[i-1])*(S(t[i-1],X[i-1])^2))
                      }
    X
         }
    res <- data.frame(replicate(M,smilstein1d()))
...
.SMilstein2D <- function(N =100,x0=2,y0=1,t0=0,T=1,Dt,driftx,diffx,drifty,diffy,
                          type=c("ito","str"),...)
                       {
    if (missing(Dt)) {
        t <- seq(t0, T, length = N + 1)
    ...
    Y[1] <- y0
    for (i in 2:(N+1)){
       X[i] = X[i-1] + Ax(t[i-1],X[i-1],Y[i-1])*Dt + Sx(t[i-1],X[i-1],Y[i-1])*dwx[i-1] +0.5 *Sx(t[i-1],X[i-1],Y[i-1]) *
              dSx(t[i-1],X[i-1],Y[i-1])*(dwx[i-1]^2-Dt)+ Dt^(3 /2)*(0.5 *Ax(t[i-1],X[i-1],Y[i-1])*dSx(t[i-1],X[i-1],Y[i-1]) + 
              0.5 * dAx(t[i-1],X[i-1],Y[i-1])*Sx(t[i-1],X[i-1],Y[i-1])+ 0.25 *(Sx(t[i -1] ,X[i -1],Y[i-1])^2) *dSxx(t[i -1] ,X[i -1],Y[i-1]))*
              dwx[i -1]+ (Dt^2) * (0.5*Ax(t[i -1],X[i -1],Y[i-1])*dAx(t[i-1],X[i-1],Y[i-1])+ 0.25 *dAxx(t[i-1],X[i-1],Y[i-1])*(Sx(t[i-1],X[i-1],Y[i-1])^2))
       Y[i] = Y[i-1] + Ay(t[i-1],X[i-1],Y[i-1])*Dt + Sy(t[i-1],X[i-1],Y[i-1])*dwy[i-1] +0.5 *Sy(t[i-1],X[i-1],Y[i-1]) *
              dSy(t[i-1],X[i-1],Y[i-1])*(dwy[i-1]^2-Dt)+ Dt^(3 /2)*(0.5 *Ay(t[i-1],X[i-1],Y[i-1])*dSy(t[i-1],X[i-1],Y[i-1]) + 
              0.5 * dAy(t[i-1],X[i-1],Y[i-1])*Sy(t[i-1],X[i-1],Y[i-1])+ 0.25 *(Sy(t[i -1] ,X[i -1],Y[i-1])^2) *dSyy(t[i -1] ,X[i -1],Y[i-1]))*
              dwy[i -1]+ (Dt^2) * (0.5*Ay(t[i -1],X[i -1],Y[i-1])*dAy(t[i-1],X[i-1],Y[i-1])+ 0.25 *dAyy(t[i-1],X[i-1],Y[i-1])*(Sy(t[i-1],X[i-1],Y[i-1])^2))
                      }
    res <- data.frame(X,Y)
...
.SMilstein3D <- function(N =100,x0=2,y0=1,z0=1,t0=0,T=1,Dt,driftx,diffx,drifty,diffy,
    ...
    Z[1] <- z0
    for (i in 2:(N+1)){
       X[i] = X[i-1] + Ax(t[i-1],X[i-1],Y[i-1],Z[i-1])*Dt + Sx(t[i-1],X[i-1],Y[i-1],Z[i-1])*dwx[i-1] +0.5 *Sx(t[i-1],X[i-1],Y[i-1],Z[i-1]) *
              dSx(t[i-1],X[i-1],Y[i-1],Z[i-1])*(dwx[i-1]^2-Dt)+ Dt^(3 /2)*(0.5 *Ax(t[i-1],X[i-1],Y[i-1],Z[i-1])*dSx(t[i-1],X[i-1],Y[i-1],Z[i-1]) + 
              0.5 * dAx(t[i-1],X[i-1],Y[i-1],Z[i-1])*Sx(t[i-1],X[i-1],Y[i-1],Z[i-1])+ 0.25 *(Sx(t[i -1] ,X[i -1],Y[i-1],Z[i-1])^2) *dSxx(t[i -1] ,X[i -1],Y[i-1],Z[i-1]))*
              dwx[i -1]+ (Dt^2) * (0.5*Ax(t[i -1],X[i -1],Y[i-1],Z[i-1])*dAx(t[i-1],X[i-1],Y[i-1],Z[i-1])+ 0.25 *dAxx(t[i-1],X[i-1],Y[i-1],Z[i-1])*(Sx(t[i-1],X[i-1],Y[i-1],Z[i-1])^2))
       Y[i] = Y[i-1] + Ay(t[i-1],X[i-1],Y[i-1],Z[i-1])*Dt + Sy(t[i-1],X[i-1],Y[i-1],Z[i-1])*dwy[i-1] +0.5 *Sy(t[i-1],X[i-1],Y[i-1],Z[i-1]) *
              dSy(t[i-1],X[i-1],Y[i-1],Z[i-1])*(dwy[i-1]^2-Dt)+ Dt^(3 /2)*(0.5 *Ay(t[i-1],X[i-1],Y[i-1],Z[i-1])*dSy(t[i-1],X[i-1],Y[i-1],Z[i-1]) + 
              0.5 * dAy(t[i-1],X[i-1],Y[i-1],Z[i-1])*Sy(t[i-1],X[i-1],Y[i-1],Z[i-1])+ 0.25 *(Sy(t[i -1] ,X[i -1],Y[i-1],Z[i-1])^2) *dSyy(t[i -1] ,X[i -1],Y[i-1],Z[i-1]))*
              dwy[i -1]+ (Dt^2) * (0.5*Ay(t[i -1],X[i -1],Y[i-1],Z[i-1])*dAy(t[i-1],X[i-1],Y[i-1],Z[i-1])+ 0.25 *dAyy(t[i-1],X[i-1],Y[i-1],Z[i-1])*(Sy(t[i-1],X[i-1],Y[i-1],Z[i-1])^2))
       Z[i] = Z[i-1] + Az(t[i-1],X[i-1],Y[i-1],Z[i-1])*Dt + Sz(t[i-1],X[i-1],Y[i-1],Z[i-1])*dwz[i-1] +0.5 *Sz(t[i-1],X[i-1],Y[i-1],Z[i-1]) *
              dSz(t[i-1],X[i-1],Y[i-1],Z[i-1])*(dwz[i-1]^2-Dt)+ Dt^(3 /2)*(0.5 *Az(t[i-1],X[i-1],Y[i-1],Z[i-1])*dSz(t[i-1],X[i-1],Y[i-1],Z[i-1]) + 
              0.5 * dAz(t[i-1],X[i-1],Y[i-1],Z[i-1])*Sz(t[i-1],X[i-1],Y[i-1],Z[i-1])+ 0.25 *(Sz(t[i -1] ,X[i -1],Y[i-1],Z[i-1])^2) *dSzz(t[i -1] ,X[i -1],Y[i-1],Z[i-1]))*
              dwz[i -1]+ (Dt^2) * (0.5*Az(t[i -1],X[i -1],Y[i-1],Z[i-1])*dAz(t[i-1],X[i-1],Y[i-1],Z[i-1])+ 0.25 *dAzz(t[i-1],X[i-1],Y[i-1],Z[i-1])*(Sz(t[i-1],X[i-1],Y[i-1],Z[i-1])^2))
                      }
